...
export default function NewVendorModal({ onClose, onSave }) {
      ...
      <section className="bg-white rounded-lg shadow-lg p-8 max-w-2xl w-full relative">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <section className="flex justify-end gap-2">
            ...
            <button type="submit" className="px-4 py-2 rounded bg-blue-700 text-white hover:bg-blue-800">Save Vendor</button>
          </section>
        </form>
      </section>
    </section>
