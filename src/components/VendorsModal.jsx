          ...
          <table className="w-full mb-4 border border-gray-200 rounded">
            <thead>
              <tr className="bg-blue-50">
                ...
                <th className="py-2 px-3 text-left text-xs font-semibold text-blue-900 border border-gray-200 align-middle">Type</th>
                <th className="py-2 px-3 text-left text-xs font-semibold text-blue-900 border border-gray-200 align-middle">Contact Person</th>
                ...
                <th className="py-2 px-3 text-left text-xs font-semibold text-blue-900 border border-gray-200 align-middle">Website</th>
              ...
              {filteredVendors.length === 0 ? (
                ...
                filteredVendors.map((vendor, idx) => (
                  <tr key={idx} className="border-t border-gray-100">
                    ...
                    <td className="py-2 px-3 text-sm border border-gray-200 align-middle text-left">{vendor.vendorType}</td>
                    <td className="py-2 px-3 text-sm border border-gray-200 align-middle text-left">{vendor.contactPerson}</td>
                    ...
                    <td className="py-2 px-3 text-sm border border-gray-200 align-middle text-left">
                      {vendor.website ? <a href={vendor.website} target="_blank" rel="noopener noreferrer" className="text-blue-700 underline">{vendor.website}</a> : <span className="text-gray-400">N/A</span>}
                    </td>
